...
def home(request):
    ...
    url= f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=5991540c715308382312e31708ea64b1'
    PARAMS = {'units':'metric'}
...
# Default placeholder image in case no results are found
    image_url = "/static/weatherpic.jpg"
